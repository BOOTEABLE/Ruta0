...
const configurarBaseDeDatos = async () => {
    try {
        ...
        await pool.query(`
            ...
            ('Café de la Vaca Centro', 'Cafeterías', '$$', 'Excelente cafetería tradicional en el centro.', -0.2201, -78.5123, ST_SetSRID(ST_MakePoint(-78.5123, -0.2201), 4326), 'Horario no disponible', 100),
            ...
            ('Yaku Museo del Agua', 'Cultura', '$', 'Museo con excelentes vistas de la ciudad.', -0.2232, -78.5186, ST_SetSRID(ST_MakePoint(-78.5186, -0.2232), 4326), 'Horario no disponible', 100);
        `);
